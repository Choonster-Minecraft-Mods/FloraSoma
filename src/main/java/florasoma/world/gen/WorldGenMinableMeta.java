...
public class WorldGenMinableMeta extends WorldGenerator
{
    ...
    /** The metadata value of the block to use in generation. */
    ...
    public WorldGenMinableMeta(IBlockState blockState, int maxMeta, int size, Predicate target)
    {
    ...
    {
        int blockMeta = random.nextInt(blockMaxMeta);
